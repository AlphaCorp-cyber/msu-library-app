...
class DueTomorrow extends StatefulWidget {
  const DueTomorrow({super.key});

  @override
  _DueTomorrowState createState() => _DueTomorrowState();
}

class _DueTomorrowState extends State<DueTomorrow> {
  List users = [];
...
var reg = box.read('username');
  fetchUser() async {
    ...
    var response = await http.get(Uri.parse(
        "https://app.library.msu.ac.zw/api/borrowers/due-tomorrow/$reg"));
    // print(response.body);
