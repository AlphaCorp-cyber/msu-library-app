...
class HomeScreenJ extends StatefulWidget {
  @override
  _HomeScreenJState createState() => _HomeScreenJState();
}

class _HomeScreenJState extends State<HomeScreenJ> {
  ...
  Future<void> fetchAllData() async {
    ...
    try {
      final response = await http
          .get(Uri.parse('https://app.library.msu.ac.zw/api/e-journal'));
  ...
  Future<void> fetchData(String query) async {
    ...
    try {
      final response = await http.get(Uri.parse(
          'https://app.library.msu.ac.zw/api/e-journal/search/$query'));
      if (response.statusCode == 200) {
        final String responseBody = response.body;
        final dynamic decodedData = json.decode(responseBody);
