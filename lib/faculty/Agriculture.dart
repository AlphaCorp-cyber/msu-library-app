...
class Agriculture extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Agriculture , Environment and Natural Resources Management"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/nrm1.jpg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "Welcome to the Agriculture , Environment and Natural Resources Management subject guide for the Midlands State University. This support page will lead you to a number of both online and hard copy resources that supports all programmes in the faculty of Natural Resources Management and Agriculture. You will also be able to discover information resources such as books, journals and articles as well to navigate some of the library platforms through the use of this guide.",
          ...
          children:  [
            //row for each deatails
             ...
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nAfrican Digital Library",style: TextStyle(color: Colors.blue)),
        ...
        child: Column(
          children:  [
            ...
            InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nBiomed Central",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nChemistry Central",style: TextStyle(color: Colors.blue)),
