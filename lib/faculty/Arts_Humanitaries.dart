...
class Arts extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Arts and Humanities"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/arts1.jpg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "The Faculty of Arts and Humanities Library provides information resources in subject areas such as African Languages, Archaeology , Cultural Heritage, Museum Studies, Communication, Film and Theatre Arts, History, Modern Languages and Theology. This Library guide focuses on the collection of different information resources to support the teaching, learning and research activities in the Faculty of Arts at the Midlands State University, Zvishavane Campus. It is designed to assist library users find approriate materials for their studies and research in the timeliest manner possible.",
