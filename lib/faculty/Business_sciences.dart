...
class BusinessSciences extends StatelessWidget {
  ...
  BusinessSciences({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Business Sciences"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/gsbl.jpg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "Welcome to the Midlands State University Faculty of Business Sciences Library Guide. This is a one stop centre for your learning, research and study resources developed to cater for the research needs of students in the Faculty of Commerce. The resources available include e-journals, e-books, hard-copy books, journals and research papers. These resources play a pivotal role in ensuring that the Library provides quality services and outstanding collections.",
          ...
          children:  [
            //row for each deatails
             ...
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nE-book Library",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nEmerald Business, Management and Economics Collection",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ), InkWell(
              child: ListTile(
