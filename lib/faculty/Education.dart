...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/edu.jpeg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "Welcome to the Education research guide. This is where you will find a one stop service to assist you in your studies or research at Midlands State University. We offer individual training to undergraduate and postgraduate students and staff in the use of different library platforms as well how to access collections.",
