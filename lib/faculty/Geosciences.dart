...
class GeoSciences extends StatelessWidget {
  ...
  GeoSciences({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Engineering and Geosciences"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/mining.jpg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "The Engineering and Geosciences Library provides information resources in subject areas such as Geology, Metallurgy, Materials Management, Geophysics, and Mining Engineering. This Library guide focuses on the collection of different information resources to support the teaching, learning and research activities in the Faculty of Engineering and Geosciences at the Midlands State University, Zvishavane Campus. It is designed to assist library users find approriate materials for their studies and research in the timeliest manner possible.",
          ...
          children:  [
            //row for each deatails
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nAccess Engineering",style: TextStyle(color: Colors.blue)),
             ...
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nEbook Central",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ), InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nEBSCOHOST E-Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ), InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nProject Muse E-Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),InkWell(
              child: ListTile(
              ...
              child: ListTile(
                title: const Text(
                    "\n\nSafari O'Reilly",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nScience Direct Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nSpringerlink E - Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),
          ],
        ...
        child: Column(
          children:  [
            ...
            InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nCambridge University Press Journals",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nEBSCOHOST",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nHighwire Press",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nIET Digital Library",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nInfosci Journals",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nLiverpool University Press",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nProject Muse",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nRoyal Society Of London",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nRoyal Society Of Chemistry",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nSabinet - African Online Journals",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nSage Journals Online",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nSpringerlink",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nTaylor And Francis Online",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nWiley Online Library",style: TextStyle(color: Colors.blue)),
