...
class FLaw extends StatelessWidget {
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/law4.jpg'),
  ),
),
      ...
      child: Card(
        ...
        child: Column(
          children: const [
            ...
            ListTile(
              title: Text(
                  "Welcome to the MSU Law Library, our mission is to provide access to appropriate legal information resources that support quality research and teaching. The library has a huge range of information resources that will assist you with your studies. Use this guide to find the most relevant legal resources for your studies.",
          ...
          children:  [
            //row for each deatails
             ...
             InkWell(
              ...
              child: ListTile(
                title: const Text(
                    "\n\nSpringer e-Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),
          ],
        ...
        child: Column(
          children:  [
            ...
            InkWell(
              ...
              child: ListTile(
                title: const Text(
                    "\n\nHeinOnline",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nVeritas Zimbabwe",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nWestlaw",style: TextStyle(color: Colors.blue)),
