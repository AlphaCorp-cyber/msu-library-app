...
class Medicine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Medicine and Health Sciences"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/medic.jpg'),
  ),
),
          ...
          children:  [
            //row for each deatails
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nAccess Medicine",style: TextStyle(color: Colors.blue)),
             ...
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nClinical Key",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ),
             InkWell(
              child: ListTile(
                title: const Text(
                    "\n\nOvid Online Books",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ), InkWell(
              child: ListTile(
              ...
              child: ListTile(
                title: const Text(
                    "\n\nScience Direct",style: TextStyle(color: Colors.blue)),
                 onTap: () => launch('https://docs.flutter.io/flutter/services/UrlLauncher-class.html')
              ),
            ), InkWell(
              child: ListTile(
        ...
        child: Column(
          children:  [
            ...
            InkWell(
              ...
              child: ListTile(
                title: const Text(
                    "\n\nHinari",style: TextStyle(color: Colors.blue)),
              ...
              child: ListTile(
                title: const Text(
                    "\n\nRoyal College of Physicians",style: TextStyle(color: Colors.blue)),
