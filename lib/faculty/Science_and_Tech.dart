...
class ScienceTech extends StatelessWidget {
  ...
  ScienceTech({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Science and Technology"),
...
Widget _getHeader() {
  ...
  child: Align(
    ...
    heightFactor: 0.5,
    widthFactor: 0.5,
    child: Image.asset('assets/fitness_app/sci.png'),
  ),
),
